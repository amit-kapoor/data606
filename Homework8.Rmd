...
**explanatory variables: calories**
**response variables: carbs**
...
* **Linearity: The relationship between calories and carbs seems linear in scatter plot.**
* **Nearly normal residuals: The residuals seem nearly normal in histogram.**
* **Constant variability: Seeing the graph, the variability is not constant as both variables increase.**
* **Independent observations: I assume data is independent.**
...
**slope: For each increase in shoulder girth, model predicts 0.61cm additional in height.**
**intercept: The intercept represents the height in cm when shoulder girth is 0cm.**

(c) Calculate $R^2$ of the regression line for predicting height from shoulder girth, and interpret it in the context of the application.

```{r r-square, eval=TRUE}
r_square <- r^2
r_square
```
